 ...
 * The main difference between Arlequin and Gppfst is that Arlequin computes significance for individual loci based on the observed level of heterozygosities, whereas GppFst will compute the probability of observing an empirical proportion of loci within a given Fst range (see Fig. 1 in manuscript and plots)
