 ...
 * Under the standard settings, Arlequin could not assign statistical significance to loci with FST of 1, whereas GppFst will compute the probability of observing an empirical proportion of loci wth FST of 1 (see Fig. 1 in manuscript and file Example_ArlequinResults.csv)
