 ...
 * Practically speaking, this means that Arlequin will always incorrectly assign statistical significance to any SNP with an FST = 1 and classify these SNPs as targets of selection, that have in fact evolved under these strictly neutral conditions. 
