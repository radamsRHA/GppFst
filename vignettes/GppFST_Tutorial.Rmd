 ...
 * Additionally, around 100 (10%) of the 1,000 simulated loci are statistically significant for each of the 100 replicate datasets.
 * Practically speaking, this means that every time Arlequin is run on a set of neutral loci that evolved under these conditions, Arlequin will always assign statistical significance to every SNP with an FST = 1. 
